...
function convertAPIMenusToFormat(apiMenus) {
    return apiMenus.map(menu => {
        ...
        // url가 있으면 추가하고 pages/ 형식으로 변환
        if (menu.url) {
            // URL이 /로 시작하면 pages/ 형식으로 변환
            // if (menu.url.startsWith('/')) {
            //     convertedMenu.url = 'pages' + menu.url + '.html';
            // } else {
                convertedMenu.url = menu.url;
            // }
        }
        
        // 자식 메뉴가 있으면 재귀적으로 변환
        if (menu.Items && menu.Items.length > 0) {
            convertedMenu.Items = convertAPIMenusToFormat(menu.Items);
        }
...
function loadDefaultMenus() {
    window.menuItems = [
        ...
        //             id: 'project-new',
        //             title: '새 프로젝트', 
        //             url: 'pages/project-new.html'
        //         },
        //         { 
        //             id: 'project-templates',
        //             title: '프로젝트 템플릿', 
        //             url: 'pages/project-templates.html'
        //         },
        //         { 
        //             id: 'project-archive',
        //             title: '보관된 프로젝트', 
        //             url: 'pages/project-archive.html'
        //         }
        //     ]
        // },
        // {
        ...
        //             id: 'task-calendar',
        //             title: '업무 달력', 
        //             url: 'pages/task-calendar.html'
        //         },
        //         { 
        //             id: 'task-timeline',
        //             title: '타임라인', 
        //             url: 'pages/task-timeline.html'
        //         },
        //         { 
        //             id: 'task-my',
        //             title: '내 업무', 
        //             url: 'pages/task-my.html'
        //         }
        //     ]
        // },
        // { 
        ...
        //             id: 'menu-management',
        //             title: '메뉴 관리', 
        //             url: 'pages/menu-management.html'
        //         }
        //     ]
        // },
        // { 
    ...
    if (item.Items && item.Items.length > 0) {
        ...
        li.innerHTML = `
            ...
            <ul class="accordion-content hidden mt-1 ml-8 space-y-1" data-accordion-content="${item.id}">
                ${createChildMenuItems(item.Items)}
            </ul>
        `;
    } else {
        // 일반 메뉴 아이템
